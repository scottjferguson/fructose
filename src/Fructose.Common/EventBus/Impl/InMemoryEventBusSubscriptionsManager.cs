...
namespace Fructose.Common.EventBus.Impl
{
    public partial class InMemoryEventBusSubscriptionsManager : IEventBusSubscriptionsManager
    {
        ...
        public void AddDynamicSubscription<TH>(string eventName) where TH : IIntegrationEventDynamicHandler
        {
        ...
        public void RemoveDynamicSubscription<TH>(string eventName) where TH : IIntegrationEventDynamicHandler
        {
        ...
        private SubscriptionInfo FindDynamicSubscriptionToRemove<TH>(string eventName) where TH : IIntegrationEventDynamicHandler
        {
