...
namespace Fructose.Common.EventBus
{
    public interface IEventBusSubscriptionsManager
    {
        ...
        void AddDynamicSubscription<TH>(string eventName) where TH : IIntegrationEventDynamicHandler;
        void AddSubscription<T, TH>() where T : IntegrationEvent where TH : IIntegrationEventHandler<T>;
        void RemoveSubscription<T, TH>() where TH : IIntegrationEventHandler<T> where T : IntegrationEvent;
        void RemoveDynamicSubscription<TH>(string eventName) where TH : IIntegrationEventDynamicHandler;
